...
$genereatedPdf = $pdf->Output('example_039.pdf', 'I');
...
//$mail->IsHTML(true);
//$mail->Username = "akbar.kusuma@zentum-intizhara.com";
//$mail->Password = "lovethehatred";
//$mail->SetFrom("PDF");
//$mail->Subject = "Test PDF ";
//$mail->Body = "Test PDF.";
//$path = 'example_039.pdf';
//$email = 'akbar.kusuma@zentum-intizhara.com';
//$mail->addStringAttachment($generatedPdf, 'example_039.pdf');
